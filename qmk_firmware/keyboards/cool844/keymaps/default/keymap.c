...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LALT, KC_LGUI,                   LT(_FN,KC_SPACE),LT(_LOWER,KC_ENTER),LSFT(KC_SPACE),  KC_LEFT,KC_DOWN,KC_RIGHT \
    ),
   /* FN */
    /* +-----------------------------------------------------------------------+
    ...
    */  
    [_FN] = LAYOUT(
        ...
        KC_LCTL, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_PLUS, KC_MINUS, KC_ASTR, KC_SLSH, KC_MINUS, KC_EQL, \
